...
export const Pricing = () => {
  return (
    <section id="pricing" className="py-20 px-6 bg-[#030303] text-white">
        ...
        <div className="flex flex-col md:flex-row items-start gap-8">
          {tiers.map((tier) => (
            <motion.div
              ...
              className={`group relative flex-1 rounded-[2.5rem] bg-[#0f0f12] p-10 md:p-12 font-sans border flex flex-col transition-colors duration-500 ${
                tier.recommended 
            ...
            >
              ...
              {/* CTA BUTTON */}
              <button 
                className={`relative z-10 w-full py-5 rounded-2xl font-bold transition-all duration-300 active:scale-95 text-lg ${
                  tier.recommended
